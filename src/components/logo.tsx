...
const Logo: React.FC<{ className: string }> = ({ className }) => {
  return (
    ...
    <svg width="100px" height="100px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
       className={className}
    <path cx="32" cy="32" r="30" fill="#ffdd67" d="M15.5 8A7.5 7.5 0 0 1 8 15.5A7.5 7.5 0 0 1 0.5 8A7.5 7.5 0 0 1 15.5 8z"/>
    <path d="M7.8 6.15c0 1.375 -1.125 2.5 -2.5 2.5s-2.5 -1.125 -2.5 -2.5 1.125 -2.5 2.5 -2.5c1.4 0 2.5 1.125 2.5 2.5" fill="#ffffff"/>
    <g fill="#664e27">
      <path cx="21.2" cy="24.6" r="4.5" d="M6.425 6.15A1.125 1.125 0 0 1 5.3 7.275A1.125 1.125 0 0 1 4.175 6.15A1.125 1.125 0 0 1 6.425 6.15z"/>
      <path d="M12.75 7.275C12.275 6.25 11.575 5.75 10.875 5.75s-1.4 0.5 -1.875 1.525c-0.05 0.1 0.2 0.3 0.325 0.2 0.45 -0.375 1 -0.525 1.55 -0.525s1.1 0.15 1.55 0.525c0.125 0.1 0.375 -0.1 0.325 -0.2"/>
      <path d="M11.975 9.5H4.025c-0.175 0 -0.275 0.125 -0.275 0.25 0 1.825 1.5 3.75 4.25 3.75s4.25 -1.925 4.25 -3.75c0 -0.125 -0.1 -0.25 -0.275 -0.25"/>
    </g>
    <path d="M10.3 11H5.7c-0.175 0 -0.2 0.075 -0.2 0.2v1C5.5 14.4 6.625 15.5 8 15.5s2.5 -1.1 2.5 -3.3v-1c0 -0.125 -0.025 -0.2 -0.2 -0.2" fill="#ff717f"/>
    <path fill="#e2596c" d="M8.375 11 8 14.45 7.625 11z"/>
  </svg>
